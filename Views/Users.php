<?php
    ...
    if (isset($_GET['Search'])) {
        ...
        $query="SELECT * FROM `User` WHERE FName LIKE '".$search."%'  ";
    }
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <form action="" method="get">
                <input type="text" name="Search"  placeholder="Search for users" style="width: 60%;border: none;border-bottom: 1px solid #999;padding: 6px 30px;font-family: Poppins;box-sizing: border-box;">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="">
            <div class="team-member">
              ...
              <div>
                 <a href="http:DeleteUser.php?id=<?= $row['ID']?> ">
